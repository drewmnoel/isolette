...
%Monitored and controlled variables tables filled out, **Still need to do messages(c_ms)**
...
\cv{ms}                      & Enumerated                   & \begin{tabular}[c]{@{}l@{}}\{ok\}\end{tabular} &                               & messages to display to nurse                                                                            \\ \hline
\end{tabular}
